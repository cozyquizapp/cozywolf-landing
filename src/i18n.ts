...
const de: Dict = {
  ...
  reHostB: 'Ich moderiere selbst, den ganzen Abend. Um das Programm musst du dich nicht kümmern, du bist einfach dabei.',
...
const en: Dict = {
  ...
  reHostB: 'I host the whole evening myself. You do not have to worry about the programme, you simply join in.',
