...
const de: Dict = {
  ...
  reUncomplicatedB: 'Deine Gäste scannen einen QR-Code und spielen am Handy. Keine App, keine Installation.',
...
const en: Dict = {
  ...
  reUncomplicatedB: 'Your guests scan a QR code and play on a phone. No app, no install.',
