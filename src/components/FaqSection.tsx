...
export function FaqSection() {
  ...
  const items: QA[] = de
    ? [
        ...
        { q: 'Ab wie vielen und bis zu wie vielen Personen geht das?', a: 'Von der kleinen Runde bis zu 100 Personen. Kleine Gruppen erobern das Spielfeld, große Gruppen treten als Fraktionen an. Der Abend passt sich an.' },
    ...
    : [
        ...
        { q: 'How many people does it work for?', a: 'From a small round up to 100 people. Small groups conquer the board, large groups play as factions. The evening adapts.' },
