...
export function FaqSection() {
  ...
  const items: QA[] = de
    ? [
        ...
        { q: 'Was kostet das?', a: (<>Es geht bei 350 € los. Der genaue Preis richtet sich nach Personenzahl und Anlass. Schreib mir kurz, worum es geht, dann bekommst du von mir ein faires Angebot. <a href="/kontakt" style={{ color: BRAND.pink, fontWeight: 800, textDecoration: 'none' }}>Anfrage schreiben</a>.</>) },
      ]
    : [
        ...
        { q: 'What does it cost?', a: (<>It starts at €350. The exact price depends on the number of people and the occasion. Drop me a line about your event and I will come back with a fair offer. <a href="/kontakt" style={{ color: BRAND.pink, fontWeight: 800, textDecoration: 'none' }}>Send a request</a>.</>) },
      ];
