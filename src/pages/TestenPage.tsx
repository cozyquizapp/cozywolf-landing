...
const C = {
  de: {
    ...
    sub: 'Ich baue ein Kneipenquiz, das euren Tisch in ein Spielfeld verwandelt — und suche ein paar Teams, die es mit mir durchspielen.',
    offerTag: 'Der Deal',
    ...
    formSub: 'Ideal seid ihr 8–12 — dann teile ich euch in Teams auf. Ich melde mich persönlich zurück.',
    or: 'Lieber direkt?',
    insta: 'Auf Instagram',
  },
  en: {
    ...
    sub: 'I am building a pub quiz that turns your table into a playing field — and I am looking for a few teams to play it through with me.',
    offerTag: 'The deal',
    ...
    formTitle: 'Sign up',
    formSub: 'Ideally you are 8–12 — then I split you into teams. I reply personally.',
    or: 'Prefer direct?',
    insta: 'On Instagram',
  },
};
