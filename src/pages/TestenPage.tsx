...
const C = {
  de: {
    ...
    steps: [
      ...
      { n: '3', t: 'Spielen & Feedback', b: 'Ihr spielt einen ganzen Abend, ich moderiere. Euer Feedback hilft mir, die App weiterzuentwickeln.' },
    ],
    formTitle: 'Meldet euch an',
    formSub: 'Ihr solltet mindestens 6 sein (2 gegen 2 gegen 2). Ich melde mich persönlich zurück.',
    or: 'Lieber direkt?',
    insta: 'Auf Instagram',
  },
  en: {
    ...
    steps: [
      ...
      { n: '3', t: 'Play & feedback', b: 'You play a whole evening, I host. Your feedback helps me develop the app further.' },
    ],
    formTitle: 'Sign up',
    formSub: 'You should be at least 6 (2 vs 2 vs 2). I reply personally.',
    or: 'Prefer direct?',
    insta: 'On Instagram',
  },
};
