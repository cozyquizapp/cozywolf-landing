...
const C = {
  de: {
    ...
    v3B: 'Kleine Runde oder volles Haus, der Abend skaliert mit. Bis zu 30 Gäste im Erober-Modus, größere Gruppen als Fraktionen bis zu 100.',
  ...
  en: {
    ...
    v3B: 'Small round or full house, the evening scales. Up to 30 guests in conquer mode, larger groups as factions up to 100.',
