...
const en: MobileDict = {
  ...
  probe: {
    ...
    cats: [
      ...
      { key: 'schaetzchen', name: 'Close Call', col: '#F59E0B', icon: '/assets/cat-schaetzchen.webp',
        claim: 'Closest guess wins. Nearly right still counts.', kind: 'guess',
        q: 'How many bones does an adult human have?', target: 206 },
      { key: 'cheese', name: 'Picture This', col: '#8B5CF6', icon: '/assets/cat-cheese.webp',
      ...
      { key: 'tuete', name: 'Lucky Bag', col: '#EF4444', icon: '/assets/cat-buntetuete.webp',
