...
const C = {
  de: {
    ...
    flowTitle: 'So läuft euer Quiz ab',
    ...
    f2B: 'Fünf abwechslungsreiche Fragetypen, und zwischen den Runden dreht das Glücksrad ein analoges Mini-Spiel an: Da wird mit echtem Material gestapelt, geworfen und balanciert. Nach jeder Frage sehen alle, welche Fraktion vorne liegt.',
  ...
  en: {
    ...
    f2B: 'Five varied question types, and between rounds the wheel of fortune spins up an analog mini game: stacking, throwing and balancing with real props. After each question everyone sees which faction is ahead.',
