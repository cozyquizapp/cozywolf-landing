...
const C = {
  de: {
    ...
    mode1B: 'Für kleinere Runden. Jedes Team beantwortet Fragen und erobert Felder auf dem Spielfeld. Wissen trifft ein bisschen Taktik.',
    mode2T: 'Cozy Arena: Fraktionen',
    mode2B: 'Für große Gruppen. Alle schließen sich zu Fraktionen zusammen und rennen Frage für Frage um die Führung. Fair gewertet, egal wie groß ein Team ist.',
    ...
    audLocationsB: 'Ein wiederkehrender Quiz-Abend, der deine Gäste bringt und hält.',
  ...
  en: {
    ...
    mode1B: 'For smaller rounds. Each team answers questions and conquers cells on the board. Knowledge meets a bit of tactics.',
    mode2T: 'Cozy Arena: factions',
    mode2B: 'For large groups. Everyone joins a faction and races for the lead question by question. Scored fairly, no matter how big a team is.',
