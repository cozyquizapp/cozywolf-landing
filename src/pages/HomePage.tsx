...
const C = {
  de: {
    ...
    hostT: 'Wer moderiert?',
    hostB: 'Ich bin Johannes, Pädagoge und Moderator. Ich stehe selbst vorne und halte das Programm zusammen, mit einem guten Blick für die Gruppe.',
    hostCta: 'Über mich',
  ...
  en: {
    ...
    audMore: 'Learn more',
    hostT: 'Who hosts?',
    hostB: 'I am Johannes, an educator and host. I stand up front myself and hold the programme together, with a good eye for the group.',
    hostCta: 'About me',
