...
const C = {
  de: {
    ...
    title: 'Live-Quiz-Events, die in Erinnerung bleiben.',
    ...
    mode1B: 'Für Runden bis zu 30 Personen. Jedes Team beantwortet Fragen und erobert Felder auf dem Spielfeld. Es gewinnt nicht automatisch das Team, das am meisten weiß.',
    ...
    why: [
      ...
      'Fragen, die ihr am nächsten Tag weitererzählt',
      'Alle am Handy, kein Zettel und Stift',
      'Fünf abwechslungsreiche Fragetypen',
      'Analoge Mini-Spiele zwischen den Runden',
    ...
    hostT: 'Wer moderiert?',
    hostB: 'Ich bin Johannes und sorge dafür, dass euer Quizabend rund läuft. Von Aufbau über Technik bis zur Moderation übernehme ich alles, ihr könnt euch entspannt zurücklehnen und den Abend genießen. Mein Ziel: dass eure Gruppe beim Rausgehen noch über die eine Schätzfrage streitet.',
    hostChips: [
  ...
  en: {
    eyebrow: 'stay cozy. stay curious.',
    title: 'Live quiz events you will remember.',
    ...
    mode1B: 'For rounds up to 30 people. Each team answers questions and conquers cells on the board. The team that knows the most does not automatically win.',
    ...
    why: [
      ...
      'Questions you will retell the next day',
      'Everyone on a phone, no pen and paper',
      'Five varied question types',
      'Analog mini games between the rounds',
    ...
    audMore: 'Learn more',
    hostT: 'Who hosts?',
    hostB: 'I am Johannes, and I make sure your quiz night runs smoothly. From setup and tech to hosting, I take care of everything, so you can sit back and enjoy the evening. My goal: your group still arguing about that one estimation question on the way out.',
    hostChips: [
