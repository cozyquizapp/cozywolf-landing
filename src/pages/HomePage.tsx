...
const C = {
  de: {
    ...
    mode2B: 'Für große Gruppen bis etwa 100 Personen. Alle schließen sich zu Fraktionen zusammen und rennen Frage für Frage um die Führung. Fair gewertet, egal wie groß ein Team ist.',
