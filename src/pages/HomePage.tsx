...
const C = {
  de: {
    ...
    hostT: 'Wer moderiert?',
    hostB: 'Ich bin Johannes, Pädagoge und Moderator. Quizze zu bauen und zu moderieren ist genau mein Ding.',
    hostCta: 'Über mich',
  ...
  en: {
    ...
    audMore: 'Learn more',
    hostT: 'Who hosts?',
    hostB: 'I am Johannes, an educator and host. Building and hosting quizzes is exactly my thing.',
    hostCta: 'About me',
