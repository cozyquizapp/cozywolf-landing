...
const C = {
  de: {
    ...
    hostT: 'Wer moderiert?',
    hostB: 'Ich bin Johannes, Pädagoge und Moderator. Quizze zu bauen und zu moderieren ist genau mein Ding, und ich habe ein gutes Gespür für die Gruppe davor.',
    hostCta: 'Über mich',
  ...
  en: {
    ...
    audMore: 'Learn more',
    hostT: 'Who hosts?',
    hostB: 'I am Johannes, an educator and host. Building and hosting quizzes is exactly my thing, and I have a good eye for the group in front of me.',
    hostCta: 'About me',
