...
const C = {
  de: {
    ...
    celebB: 'Keiner sitzt daneben, alle raten mit. Ihr lacht, ihr grübelt, und am Ende wird der Sieger gefeiert.',
    ...
    p2B: 'Schätzen, tippen, kombinieren, und zwischen den Runden wird mit echtem Material gestapelt und geworfen, da zählt Geschick statt Wissen. Auch wer sich nicht als Quiz-Profi sieht, kann den Abend drehen.',
    ...
    f3T: 'Sieger feiern',
    f3B: 'Am Ende steht fest, wer den Abend für sich entschieden hat. Erfahrungsgemäß fordern die Verlierer noch am selben Abend Revanche.',
    occTitle: 'Passt zu',
  ...
  en: {
    ...
    celebB: 'Nobody sits out, everyone joins in. You laugh, you puzzle, and in the end you celebrate the winner.',
    ...
    p2B: 'Guess, tap, combine, and between rounds you stack and throw real props, where skill beats knowledge. Even if you do not see yourself as a quiz pro, you can turn the evening around.',
    p3T: 'I do the rest',
    ...
    f3B: 'At the end it is clear who won the evening. In my experience the losers demand a rematch that same night.',
